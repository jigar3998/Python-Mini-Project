...
def extract_text():
    ...
    file = filedialog.askopenfile(
        parent=root, mode='rb', title='Choose a PDF file')
    if file != None:
...
def speak_text():
    ...
    # extracting all voices from engine
...
def Application(root):
    ...
    # frame 1 for project name and desc.
    frame1 = Frame(root, width=500, height=200, bg="#8a2be2")
    frame2 = Frame(root, width=500, height=450,
                   bg="#e0ffff")  # frame 2 for rest part
    frame1.pack(side="top", fill="both")
    frame2.pack(side="top", fill="y")

    # frame 1 widgets
    name1 = Label(frame1, text="Convert E-book to Audio book", fg="white",
                  bg="#8a2be2", font="Arial 28 bold")
    name1.pack()
    name2 = Label(frame1, text="A Simple E-book Audio Reader for you!", fg="white",
                  bg="#8a2be2", font="Calibri 15")
    name2.pack()

    # frame 2 widgets
    btn = Button(frame2, text='Select E-book', command=extract_text, activeforeground="red",
    ...
    voice_text = Label(frame2, text="Voice:", fg="black",
                       bg="#e0ffff", font="Arial 12")
    ...
    submitBtn = Button(frame2, text='Play E-book', command=speak_text, activeforeground="red",
